  ...
  return (
    <div className={
      theme === "gradient"
        ...
        : "flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-white dark:bg-gray-900 dark:text-white px-8 py-6 shadow-lg mb-6 border-4 border-gray-300 dark:border-gray-600"
    }>
